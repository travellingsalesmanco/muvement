  ...
  render() {
    return (
      <div>
        ...
        <p>Your privacy is important to us. It is Travelling Salesman's policy to respect your privacy regarding any information
          we may collect from you across our website, <a href="https://muvement.app">https://muvement.app</a>, and other sites we
          own and operate.</p>
        ...
        <p>Your continued use of our website will be regarded as acceptance of our practices around privacy and personal
          ...
          us.</p>
        <p>This policy is effective as of 24 October 2018.</p>
      </div>
    );
  }
}
