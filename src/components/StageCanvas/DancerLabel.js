...
import { Label, Path, Tag, Text } from 'react-konva';
...
class DancerLabel extends PureComponent {
  ...
  render() {
    ...
    return (
      <Label
        x={-(this.state.labelWidth ? (this.state.labelWidth + iconSize) / 2 : 50)}
      ...
      >
        ...
        <Path
          x={this.state.labelWidth ? this.state.labelWidth : 80}
